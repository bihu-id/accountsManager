...
contract Data is BaseLogic{
    ...
    function(){
        assembly {
            ...
            //return fun call gas need  is stored on memery from 0x60~0x7F,
            //mem free start 0x80
            call(100000,sload(0x0),callvalue,0x3c, 0x24, 0x20, 0x60)
            ...
            jumpi(0x02,iszero(delegatecall(mload(0x60), mload(0x20), 0x80, calldatasize, 0x60, mload(0x40))))
