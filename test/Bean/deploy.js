...
Data.deploy(privateKey,[proxyAddress]).then(function(BeanData,err){
    ...
    Bean.initBean([issuer,symbol,0,20000000000000,2,100,0,"测试分红豆","0xabcdf",Contract.getAddress("TokenManagerData"),Contract.getAddress("DividendTokenData")],privateKey).then(function(receipt,err){
