...
TokenManager.at();
var dataAddress=Contract.getAddress('BeanData')

Bean.at('BeanData')
console.log(Bean.address)
Bean.init([issuer,symbol,0,20000000000,2,1000,0,"测试分红豆","0xabcdf",TokenManager.address],privateKey).then(function(receipt,err){
