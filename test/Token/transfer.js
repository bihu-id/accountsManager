            ...
            tokenManager.getTokenSummary(2).then(function(res1){
                ...
                token.summary().then(function(res2){
                    ...
                    accountI.summary().then(function (res4) {
                        console.log("account :%s owner: %s",res2[1],res4[8].toString(16))
                        ...
                        console.log("use %s to transfer ",res4[8].toString(16))
                        return accountI.transferToken(res1[2],accounts[21],11234,{from:res4[8].toString(16),gas:20000000}).then(function(tx){
                            console.log(tx);
                            //console.log(web3.eth.getTransactionReceipt(tx));
                            token.balanceOf(accounts[21]).then(function(res3){
                                console.log(accounts[21],res3.toString())
                            })
                        });
                    });
                })
