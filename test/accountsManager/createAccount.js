            ...
            for(var i=res;i<=res;i++) {
                ...
                accountmanager.getAccountAddress(i).then(function (res1,i) {
                    ...
                    account.summary().then(function (res,i) {
                        ...
                        console.log(i, res1.toString(16),res[0].toString(16),res[1].toString(16),"   "+res[2].toString(10),"      "+res[3].toString(10),"        "+res[4].toString(10),"           "+res[5].toString(10),res[6].toString(16),res[7].toString(16),res[8].toString(10));
